<script>
	...
	export default {
		...
		setup() {
			...
			return { userStore, searchStore, feedStore }
		},
		mounted() {
		...
		methods: {
			scrollToView() {
				this.$refs.main.scrollIntoView({ behavior: 'smooth', block: 'start', inline: 'nearest' });
				// document.getElementById('feed').scrollIntoView({ behavior: 'smooth', block: 'start', inline: 'nearest' })
			}
		}
	}
</script>
