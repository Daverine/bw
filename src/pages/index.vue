	...
	<header id="main-header">
		...
		<form id="searchbox" class="centered" @submit.prevent="searchStore.triggerSearch()">
			<div style="margin-bottom: 16px;">
				<img src="/images/logo_full.png" alt="site logo" class="site-logo fluid image" style="max-width: 450px; background-color: rgba(128,128,128,0.025);" />
				<p class="huge" style="margin-top: 0px;">Search for business names, products and services.</p>
			</div>
			<div>
