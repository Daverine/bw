        ...
        <div style="padding: 1em 1.5em;">
            ...
            <table class="dm-info table borderless">
              <tbody>
                <tr>
                  ...
                  <td>{{ details.description }} <a :href="`${details.bizUrl}/about_us`" target="_blank">Learn more.</a>
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <table class="table compact clear 0-margined">
                      <tbody>
                        <tr v-for="(hour, i) in details.hours" :key="i"
          ...
          <div>
            ...
            <div class="dm-reviews">
              ...
              <div v-if="details.reviews.length > 5" class="centered"><a href="#" class="text primary button">More
                  reviews ({{
    ...
    <template v-else-if="details.type === 'product'">
      ...
      <div class="footer auto-t-bordered flexbox" style="gap: 0.5em;">
        ...
        <button class="circular button">
          <SvgIcon name="share_filled" />
        </button>
        <button class="outlined circular button" style="margin-left: auto;">
        ...
        <div class="dm-display">
          <div class="dm-media">
            <Carousel class="dm-dps" :options="{ slidesHeight: 'inherit' }">
              <div v-for="slide in details.media" class="cs-slide">
                <img v-if="slide[0] === 'pic'"
                  src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                  :style="`width: 100%; height: 100%; background-image: url(${slide[1]}); background-size: contain; background-repeat: no-repeat; background-position: center;`" />
              </div>
            </Carousel>
          </div>
        </div>
